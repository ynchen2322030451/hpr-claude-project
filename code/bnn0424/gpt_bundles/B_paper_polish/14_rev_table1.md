...
| MC-Dropout | σ_max (MPa) | 0.9337 | ~7.66 |
| Deep Ensemble | σ_max (MPa) | 0.9340 | **~7.64** |
| | | | |
...
prediction. BNN-phy-mono achieves the highest stress R² (0.9438) among all models,
though DE (0.9340) and MC-D (0.9337) are comparable. The physics-regularized BNN
