...
### Test performance (bnn-phy-mono, fixed-split test set n=501)
| Output | R² | RMSE | Units |
|--------|-----|------|-------|
| iteration2_max_global_stress | 0.944 | 7.39 | MPa |
| iteration2_keff | 0.849 | 2.78×10⁻⁴ | — |
| iteration2_max_fuel_temp | 0.628 | 4.05 | K |
| iteration2_max_monolith_temp | 0.597 | 4.49 | K |
| iteration2_wall2 | 0.994 | 1.64×10⁻³ | cm |
| iteration1_max_global_stress | 0.923 | 12.0 | MPa |
...
| Acceptance rate | 0.58–0.63 (mean 0.606) |
