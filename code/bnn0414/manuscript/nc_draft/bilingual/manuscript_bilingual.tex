...
偏远社区、国防设施及太空任务中的分布式供能而开发\textsuperscript{1,14}。
NASA 与 DOE 正推进月面及行星任务的裂变地表供电系统\textsuperscript{15}，
与此同时 AI 密集型数据中心电力需求的快速增长进一步强化了分布式、
可调度零碳发电的需求\textsuperscript{16}。与常规大型电厂不同，
...
MOOSE 生态\textsuperscript{10,11} 与数字孪生管线\textsuperscript{12}
...
与 FEniCS 有限元求解器\textsuperscript{17}。保留两个保真度水平：耦合
...
代理为采用均场变分推断（MFVI，Bayes-by-Backprop\textsuperscript{22}）
